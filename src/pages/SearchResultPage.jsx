        ...
        <div>
            ...
            <div className="p-8 min-w-[1200px]">
                ...
                <div className="max-w-[960px] mx-auto flex flex-col gap-6">
                    {loading ? (
                        <div className="py-8 text-center text-[14px] text-[#8892B0]">로딩 중...</div>
                    ) : error ? (
                        ...
                        <>
                            ...
                            <div className="border border-[#233554] bg-[#112240] rounded-lg p-6">
                                <h2 className="text-[18px] font-bold text-[#CCD6F6] mb-4">
                                    "{keyword}" 코인 검색 결과
                                </h2>
                                {cryptos.length === 0 ? (
                                    <div className="py-6 text-center text-[14px] text-[#8892B0]">
                                        검색 결과가 없습니다.
                                    </div>
                                ) : (
                                    <div className="flex flex-col gap-2">
                                        {cryptos.map((coin) => (
                                            <div
                                                key={coin.ticker}
                                                className="flex items-center gap-3 py-3 px-2 border-b border-[#233554] last:border-b-0 cursor-pointer hover:bg-[#1E3A5F] transition-colors"
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <p className="text-[15px] font-medium text-[#CCD6F6]">{coin.name}</p>
                                                    <p className="text-[13px] text-[#8892B0]">{coin.ticker}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                            ...
                            {/* 뉴스 검색 결과 */}
                            <div className="border border-[#233554] bg-[#112240] rounded-lg p-6">
                                <h2 className="text-[18px] font-bold text-[#CCD6F6] mb-2">
                                    "{keyword}" 뉴스 검색 결과
                                </h2>
                                {newsList.length === 0 ? (
                                    <div className="py-6 text-center text-[14px] text-[#8892B0]">
